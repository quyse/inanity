exports.configureCompiler = function(objectFile, compiler) {
	...
	compiler.addIncludeDir(`include_${compiler.platform}_${compiler.arch}`);
...
'rng.processor_rng.processor_rng',
'rng.rng',
...
'utils.filesystem',
'utils.ghash.ghash',
'utils.ghash.ghash_cpu.ghash_cpu',
'utils.ghash.ghash_vperm.ghash_vperm',
'utils.http_util.http_util',
'utils.locking_allocator.locking_allocator',
'utils.mem_ops',
'utils.mem_pool.mem_pool',
...
exports.configureComposer = function(libraryFile, composer) {
	...
	var objects = objectsByPlatform[`${composer.platform}_${composer.arch}`];
