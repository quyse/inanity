...
* 'configure.py --with-build-dir=../build --module-policy=modern --link-method=copy --with-zlib --with-boost --enable-modules=asio,certstor_system --disable-modules=ffi,certstor_sql,win32_stats --disable-rdrand --disable-rdseed --disable-shared-library --cpu=x86_32 --os=macos --cc=clang --enable-modules=certstor_system_macos'
*
* Target
*  - Compiler: clang++ -fstack-protector -m32 -pthread -stdlib=libc++ -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_32
*  - OS: macos
*/
...
#define BOTAN_LINK_FLAGS "-fstack-protector -m32 -pthread -stdlib=libc++"
